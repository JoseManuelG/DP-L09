...
public class TripTest extends AbstractTest {
	...
	public static Collection<Object[]> data() {
		...
		/*
		 * [8] En este test se crea un "offer" con el campo description vacio. Se espera un ConstraintViolationException.
		 */
		params.add(new Object[] {
		...
		/*
		 * [9] En este test se crea un "offer" con el campo destination vacio. Se espera un ConstraintViolationException.
		 */
		params.add(new Object[] {
			true, "customer1", 1, "test", "", null, null, "test", null, null, "test", ConstraintViolationException.class
		});
		...
		/*
		 * [12] En este test se crea un "offer" con el campo origin vacio. Se espera un ConstraintViolationException.
		 */
		params.add(new Object[] {
		...
		/*
		 * [15] En este test se crea un "offer" con el campo title vacio. Se espera un ConstraintViolationException.
		 */
		params.add(new Object[] {
		...
		/*
		 * [16] En este test se crea un "offer" con una coordenada fuera de rango. Se espera un ConstraintViolationException.
		 */
		params.add(new Object[] {
		...
		/*
		 * [21] En este test se crea un "offer" con una coordenada fuera de rango. Se espera un ConstraintViolationException.
		 */
		params.add(new Object[] {
		...
		/*
		 * [22] En este test se crea un "offer" con una coordenada fuera de rango. Se espera un ConstraintViolationException.
		 */
		params.add(new Object[] {
		...
		/*
		 * [27] En este test se crea un "offer" con una coordenada fuera de rango. Se espera un ConstraintViolationException.
		 */
		params.add(new Object[] {
